...
- `cd ~/`
- `git clone -b master --single-branch --depth=1 https://github.com/MycroftAI/mycroft-core.git`
- `cd mycroft-core`
- `bash dev_setup.sh`
...
NOTE: The above git command clones the master branch, which is considered the stable branch of Mycroft. 
